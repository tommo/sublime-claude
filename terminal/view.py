...
class ClaudeTerminalInsertCommand(sublime_plugin.TextCommand):

    def run(self, edit, point, character):
        self.view.insert(edit, point, character)


class ClaudeTerminalTrimTrailingLinesCommand(sublime_plugin.TextCommand):
...
class ClaudeTerminalNukeCommand(sublime_plugin.TextCommand):
