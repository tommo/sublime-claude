...
def create_sublime_router() -> ToolRouter:
    ...
    router.register("list_sessions", lambda args:
        "return list_sessions(_caller_view_id={})".format(
            int(args["_caller_view_id"])
            if args.get("_caller_view_id") is not None else "None"))
